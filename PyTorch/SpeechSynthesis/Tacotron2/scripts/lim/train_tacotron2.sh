...
traindataroot=/mnt/tmp/datasets/lim
...
trainfiles=$traindataroot/filelists/mel_text_train_filelist.txt
valfiles=$traindataroot/filelists/mel_text_val_filelist.txt
